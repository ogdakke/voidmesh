...
export const MANY_ENTITY_SCENARIOS: readonly ManyEntityScenarioConfig[] = [
  ...
  {
    id: "many-131072-shared-mixed-static-drag-single-selected",
    label: "131,072 shared mixed instances, dragging one",
    description:
      "Moves one selected entity through the mixed full-scene GPU transform without rebuilding the scene on each drag frame.",
    entityCount: 131_072,
    uniqueAssetCount: 1,
    sourceSize: { width: 1024, height: 1024 },
    displaySize: { width: 6, height: 6 },
