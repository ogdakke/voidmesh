...
- `CanvasProvider` owns the canvas access policy. Hosted viewer enforcement must cover commands,
  media controls, exports, and engine input; hiding UI controls alone is not authorization.
