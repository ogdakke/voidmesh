...
export const LOCAL_CANVAS_ACCESS: CanvasAccessPolicy = Object.freeze({
  canEdit: true,
...
const CanvasAccessContext = createContext<CanvasAccessPolicy>(LOCAL_CANVAS_ACCESS);
...
export function useCanvasAccess(): CanvasAccessPolicy {
  return use(CanvasAccessContext);
}
