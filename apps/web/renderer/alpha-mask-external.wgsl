// Keeps fully transparent external source pixels transparent after an effect pass.
...
fn fs_main(@builtin(position) fragCoord: vec4f) -> @location(0) vec4f {
  ...
  let sourceAlpha = textureSampleBaseClampToEdge(maskTexture, texSampler, uv).a;
