...
- Bound collaborative asset requests and serialize whole-asset sends per peer. Require a receiver acknowledgement after restore and hash verification before sending the next Blob; incomplete sends, negative acknowledgements, and departed peers must release or retry pending work rather than strand placeholders.
