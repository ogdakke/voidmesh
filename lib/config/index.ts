...
export const config = {
  ...
  rendering: {
    ...
    videoPreviewAdaptive: {
      ...
      upgradeProbationSamples: 360,
      successfulUpgradeCooldownSamples: 720,
      failedUpgradeCooldownSamples: 2400,
      failedUpgradeDetectionSamples: 120,
      failedUpgradeRetrySamples: 36000,
      minLongEdge: 1280,
