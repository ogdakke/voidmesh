...
- Keep format code platform-neutral. It may depend on Yjs, but not React, Cloudflare bindings, D1, R2, or browser-only media APIs.
- Validate Yjs values before converting them into archive records; collaborative document bytes are untrusted input.
